...
Copyright (c) 2014-2015 Slothcoin developers
...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless Slothcoin

See readme-qt.rst for instructions on building Slothcoin-Qt, the graphical user interface.
...
---------------------
 ...
 libcrypto++ Cryptography      Provides implementations for cryptography in Slothcoin
...
Notes
-----
The release is built with GCC and then `strip Slothcoind` to strip the debug
...
Security
--------
To help make your Slothcoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Slothcoin should be built with a non-executable stack
